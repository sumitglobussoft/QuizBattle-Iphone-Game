...
{
    //NSLog(@"isTransactionAndItsReceiptValid");
...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data
{
    ...
    if (isOk)
    {
        ...
        int totalDia =  [userDefault integerForKey:@"buydiamond"];
        ...
        if ([strProductId isEqualToString:@"com.globussoft.diamondx2"]) {
            
            diaCountx2 = 2;
        }
        else if ([strProductId isEqualToString:@"com.globussoft.diamondx6"]) {
            
            diaCountx6 = 6;
        }
        else if ([strProductId isEqualToString:@"com.globussoft.diamondx11"]) {
            
            diaCountx11 = 11;
        }
        else if ([strProductId isEqualToString:@"com.globussoft.diamondx24"]) {
            
            diaCountx24 = 24;
        }
        else if ([strProductId isEqualToString:@"com.globussoft.diamond78"]) {
            diaCountx78 = 78;
        }
        else {
            diaCountx140 = 140;
        }
        int buyDia = diaCountx2+diaCountx6+diaCountx11+diaCountx24+diaCountx78+diaCountx140+totalDia;
        [userDefault setInteger:buyDia forKey:@"buydiamond"];
       ...
       /* NSDictionary *temp = [responseString JSONValue];
        if (temp) {
            if ([temp objectForKey:@"receipt"]) {
               // [handler performSelector:action withObject:[[temp objectForKey:@"receipt"] objectForKey:@"product_id"]];
            }
        }*/
